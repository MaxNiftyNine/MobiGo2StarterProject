 ...
 *
 * Movie data is appended to the cartridge by tools/build.ps1. Frames are
 ...
 *
 * A short unsigned 8-bit PCM excerpt is appended after the movie. Channel 0
...
/* Patched by tools/build.py after the linked program size is known. */
#ifndef MOVIE_ADDR
#define MOVIE_ADDR 0x050800UL
#endif
#ifndef MOVIE_FRAMES
#define MOVIE_FRAMES 1u
#endif
#ifndef AUDIO_ADDR
#define AUDIO_ADDR 0x051000UL
#endif
...
int main(void)
{
    ...
    /* The movie follows the linked player inside the loaded MBA image. Keep
     * the loader's memory-controller mapping intact. */
    for (;;) {
