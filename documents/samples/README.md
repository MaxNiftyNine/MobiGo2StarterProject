...
- `color_cycle` — minimal real-hardware-confirmed G1 program. Start here.
- `bad_apple_player` — real-hardware-confirmed video path with experimental
  audio V6. Media is intentionally absent.
