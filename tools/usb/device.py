...
The macOS transport is based on the validated reverse-engineering prototype.
The Windows transport follows the raw-volume approach in
MaxNiftyNine/VTech-MobiGo2-Reverse-Engineering-Dump.
"""
