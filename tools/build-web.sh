...
cp "$ROOT/web/index.html" "$ROOT/web/style.css" "$ROOT/web/.nojekyll" "$OUT/"
...
python3 "$PACKAGER" "$OUT/nand_part01.data" --preload "$ROOT/firmware/nand.us-stitched.bin.part01@/nand.bin.part01" --js-output="$OUT/nand_part01.js"
