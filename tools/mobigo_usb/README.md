...
```text
mobigo_developer_mode.command
mobigo_install_mba.command
mobigo_storage.command
```

They can also be run non-interactively:

```sh
./mobigo_developer_mode.command --enable
./mobigo_developer_mode.command --disable
./mobigo_install_mba.command --g1 build/MobiGo2Starter.MBA
./mobigo_install_mba.command --system build/MobiGo2Starter.MBA
./mobigo_install_mba.command --root build/MobiGo2Starter.MBA
./mobigo_storage.command --check
```
...
```text
mobigo_developer_mode.bat
mobigo_install_mba.bat
mobigo_storage.bat
```
...
```powershell
.\mobigo_developer_mode.bat --disable
.\mobigo_install_mba.bat --g1 .\build\MobiGo2Starter.MBA
.\mobigo_install_mba.bat --system .\build\MobiGo2Starter.MBA
.\mobigo_install_mba.bat --root .\build\MobiGo2Starter.MBA
.\mobigo_storage.bat --check
```
...
```sh
./mobigo_install_mba.command --delete /MobiGo2Starter.MBA
```
...
```sh
python3 tools/mobigo_usb/developer_mode.py --help
python3 tools/mobigo_usb/install_mba.py --help
python3 tools/mobigo_usb/storage.py --help
```